"""
Base for Content Manager Dashboard App.
Author: Information First, Esme Middaugh, emiddaugh@info-first.com
Last Updated: 2020SEP24

Modify the top portion of this script to suit your Content Manager DataSet & Color Theme Preferences
...
INPUT_DIR = os.path.join(BASE_DIR, 'data/')  # data stored from model.py
